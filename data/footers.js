...
let tips = [
    'Need help? Check out the support server. A link is present on Sylveon\'s website.',
    'If you like Sylveon, consider donating to keep it alive! Check out Sylveon\'s website for more details.',
    'Don\'t recognize any values given? Try using the unit conversion command to translate them.',
    'Sylveon\'s italicization detector supports shinies! Simply put "shiny " before the pokémon\'s name to get its shiny version.',
    'Have a feature you want to suggest? Visit Sylveon\'s support server! You can find a link on Sylveon\'s website.'
];
